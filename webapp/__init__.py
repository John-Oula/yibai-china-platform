...
class Post(db.Model):
    __tablename__ = 'post'
    id = db.Column('id', db.Integer, primary_key=True)
    meetingId = db.Column('MeetingId', db.BigInteger,nullable=True)
    ...
    def __repr__(self, id,meetingId, verified, title, category, description, files, date, user_id, start_time,
                 end_time):
        self.id = id
